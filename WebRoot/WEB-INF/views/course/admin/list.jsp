	...
	<c:forEach items="${courses }" var="course" varStatus="st">
		<dl>
			...
			<dd>
				...
				<div class="rt">
					<a id="cmd_remove" href="/course/admin/delete?id=${course.id}&platformId=${platformId}">删除</a>
					<a id="cmd_modify" href="${_CTX_PATH_ }/course/admin/modify?id=${course.id}&platformId=${platformId}">修改</a>
				</div>
			</dd>
			<dd>
